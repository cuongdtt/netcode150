...
describe("Find K Closest Elements - Edge Cases", () => {
    ...
    test("should handle k equal to array length", () => {
        ...
        expect(findClosestElements([5,4,3], 3, 1)).toEqual([3,4,5]);
    });
...
describe("Find K Closest Elements - Common Patterns", () => {
    ...
    test("should handle negative numbers", () => {
        expect(findClosestElements([-5,-3,-1,1,3], 3, 0)).toEqual([-1,1,3]);
...
describe("Find K Closest Elements - Boundary Conditions", () => {
    ...
    test("should return elements in ascending order", () => {
        expect(findClosestElements([5,1,3,9,7], 3, 4)).toEqual([1,3,5]);
        expect(findClosestElements([10,2,8,4,6], 2, 5)).toEqual([4,6]);
    });
});
...
describe("Find K Closest Elements - Complex Scenarios", () => {
    ...
    test("should handle clustered elements", () => {
        expect(findClosestElements([1,2,3,100,101,102], 3, 50)).toEqual([1,2,3]);
        expect(findClosestElements([1,2,3,100,101,102], 3, 101)).toEqual([100,101,102]);
    });

    test("should handle edge selection", () => {
        expect(findClosestElements([1,3,5,7,9,11], 4, 2)).toEqual([1,3,5,7]);
        expect(findClosestElements([1,3,5,7,9,11], 4, 10)).toEqual([5,7,9,11]);
    });
